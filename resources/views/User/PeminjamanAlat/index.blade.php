...
@section('content')
    @if(session()->exists('success'))
        <script>
            ...
            window.open(`https://api.whatsapp.com/send?phone=${getAsisten(Object.values(asisten))}&text=Assalamualaikum,%20Saya%20meminta%20izin%20untuk%20meminjam%20alat%20berupa%20_____%20dengan%20jumlah%20____buah`)
        </script>
                                    ...
                                    @if($item->status === '0')
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                ...
                                                <div class="text-sm text-gray-500">Rp.{{ number_format($item->alat->harga_alat) }} × 10</div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm text-gray-900">{{ $item->tanggal_pinjam }} - {{ $item->tanggal_kembali }}</div>
                                                <div class="text-sm text-gray-500">{{ $item->jam_pinjam }} - {{ $item->jam_kembali }}</div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap flex flex-col items-start">
                                                ...
                                                @if($item->proses === '2')
                                                    <a class="px-2 py-1 mt-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-blue-200 text-blue-800" href="{{ route('UserPeminjamanAlat.exportToWord', $item->id) }}">
        ...
        <dl class="space-y-10 md:space-y-0 grid md:gap-4 grid-rows-4 grid-flow-col container mx-auto">
            ...
            <div class="flex">
                ...
                <div class="ml-4">
                    ...
                    <dd class="mt-2 text-base text-gray-800">
                        Mengisi formulir yang berkaitan dengan peminjaman alat, seperti data diri, alat yang akan dipinjam dan lain sebagainya pada halaman berikut:
                        <a href="{{ route('UserPeminjamanAlat.create') }}" class="font-bold text-indigo-800 hover:underline">Formulir Peminjaman Alat</a>
                    </dd>
                </div>
            </div>
            <div class="flex">
            ...
            <div class="flex">
                ...
                <div class="ml-4">
                    ...
                    <dd class="mt-2 text-base text-gray-800">
                        Setelah selesai meggunakan alat, kembalikan alat dalam keadaan baik beserta pembayaran biaya peminjamannya
                    </dd>
                </div>
            </div>
            <div class="flex">
