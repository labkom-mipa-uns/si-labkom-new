                    ...
                    <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">Proyektor</div>
                                    <div class="text-sm text-gray-500">Rp.30,000 × 10</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">01 Jan 2021 - 01 Feb 2021</div>
                                    <div class="text-sm text-gray-500">12:00 - 12:00</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
