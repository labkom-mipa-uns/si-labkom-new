            ...
            <form method="post" action="{{ route('UserPeminjamanAlat.store') }}">
                ...
                <div class="p-8 -mr-6 -mb-8 flex flex-wrap">
                    ...
                    <div class="pr-6 pb-8 w-full lg:w-1/2">
                        ...
                        <select id="id_alat" name="id_alat" class="form-select">
                            <option></option>
                    ...
                    <div class="pr-6 pb-8 w-full lg:w-1/2">
                        ...
                        <input id="tanggal_pinjam" name="tanggal_pinjam"
                            class="form-input @error('tanggal_pinjam') error @enderror" autocomplete="off" type="date"
                    ...
                    <div class="pr-6 pb-8 w-full lg:w-1/2">
                        ...
                        <input id="tanggal_kembali" name="tanggal_kembali"
                            class="form-input @error('tanggal_kembali') error @enderror" autocomplete="off" type="date"
                    ...
                    <div class="pr-6 pb-8 w-full lg:w-1/2">
                        ...
                        <input id="jam_pinjam" name="jam_pinjam" class="form-input @error('jam_pinjam') error @enderror"
                            autocomplete="off" type="time" value="{{ old('jam_pinjam') }}" />
                        @error('jam_pinjam')
                            <div class="form-error">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="pr-6 pb-8 w-full lg:w-1/2">
                        ...
                        <input id="jam_kembali" name="jam_kembali" class="form-input @error('jam_kembali') error @enderror"
                            autocomplete="off" type="time" value="{{ old('jam_kembali') }}" />
                        @error('jam_kembali')
                            <div class="form-error">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="px-8 py-4 bg-gray-100 border-t border-gray-200 flex justify-end items-center">
                    ...
                    <button type="submit" id="user-pinjam-alat-create" class="btn-indigo">
                        Ajukan Permohonan
                    </button>
                </div>
            </form>
