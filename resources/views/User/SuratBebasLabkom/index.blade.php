...
@section('content')
    ...
    <div class="bg-white min-h-full md:py-16 lg:py-24">
                                                ...
                                                <span
                                                    ...
                                                    text-green-800 @endif @if ($item->proses === '1') bg-yellow-100 text-yellow-800
                                                        @endif @if ($item->proses === '0')
                                                            ...
                                                            @if ($item->proses === '2')
                                                            {{ __('Sudah Disetujui') }} @elseif($item->proses === '1')
                                                            {{ __('Sedang Diproses') }} @elseif($item->proses === '0')
                                                                {{ __('Ditolak') }} @endif
                                                </span>
                                                @if ($item->proses === '2')
                                                    <a class="px-2 py-1 mt-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-blue-200 text-blue-800"
                                                        href="{{ route('UserSuratBebasLabkom.exportToWord', $item->id) }}">
        ...
        <dl class="space-y-10 md:space-y-0 grid md:gap-4 grid-rows-3 grid-flow-col container mx-auto">
            <div class="flex">
                ...
                <div class="ml-4">
                    ...
                    <dd class="mt-2 text-base text-gray-800">Mengisi data diri untuk pembuatan <i>Surat Bebas Labkom</i> di
                        halaman berikut: <a href="{{ route('UserSuratBebasLabkom.create') }}"
                            class="font-bold text-indigo-800 hover:underline">Formulir Surat Bebas Labkom</a></dd>
                </div>
            </div>
            <div class="flex">
                <div class="flex-shrink-0">
        ...
        <div class="flex justify-center">
            ...
            <a href="{{ route('UserSuratBebasLabkom.create') }}"
