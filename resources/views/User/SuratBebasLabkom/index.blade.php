...
@section('content')
    @if(session()->exists('success'))
        <script>
            ...
            window.open(`https://api.whatsapp.com/send?phone=${getAsisten(Object.values(asisten))}&text=Assalamualaikum,%20Saya%20meminta%20izin%20untuk%20dibuatkan%20surat%20keterangan%20bebas%20labkom%20sebagai%20syarat%20untuk%20____`);
        </script>
