...
@section('content')
    @if (session()->exists('success'))
        <script>
            ...
            window.open(
                `https://api.whatsapp.com/send?phone=${getAsisten(Object.values(asisten))}&text=Assalamualaikum,%20Saya%20meminta%20izin%20untuk%20meminjam%20lab%20____%20pada%tanggal%20____`
            );
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap flex flex-col items-start">
                                                ...
                                                @if ($item->proses === '2')
                                                    <a class="px-2 py-1 mt-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-blue-200 text-blue-800"
                                                        href="{{ route('UserPeminjamanLab.exportToWord', $item->id) }}">
                                                        <svg focusable="false" data-prefix="fas" data-icon="file-word"
        ...
        <dl class="space-y-10 md:space-y-0 grid md:gap-4 grid-rows-4 grid-flow-col container mx-auto">
            ...
            <div class="flex">
                ...
                <div class="ml-4">
                    ...
                    <dd class="mt-2 text-base text-gray-800">
                        Mengisi formulir yang berkaitan dengan peminjaman ruang, seperti data diri, lab yang akan dipinjam
                        dan lain sebagainya pada halaman berikut:
                        <a href="{{ route('UserPeminjamanLab.create') }}"
                            class="font-bold text-indigo-600 hover:underline">Formulir Peminjaman Ruang</a>
                    </dd>
                </div>
            </div>
            <div class="flex">
            ...
            <div class="flex">
                ...
                <div class="ml-4">
                    ...
                    <dd class="mt-2 text-base text-gray-800">
                        Pada saat ingin mengambil kunci di <b>Ruang Pengelola</b>, bawa dokumen yang diperlukan seperti
            ...
            <div class="flex">
                ...
                <div class="ml-4">
                    ...
                    <dd class="mt-2 text-base text-gray-800">
                        Setelah selesai meminjam ruangan laboratorium, pastikan AC, PC dan lainnya sudah dimatikan, lalu
                        kembalikan kunci ke <b>Ruang Pengelola</b>
                    </dd>
                </div>
            </div>
            <div class="flex">
