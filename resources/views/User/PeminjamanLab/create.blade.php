            ...
            <form method="post" action="{{ route('UserPeminjamanLab.store') }}">
                ...
                <div class="p-8 -mr-6 -mb-8 flex flex-wrap">
                    ...
                    <div class="pr-6 pb-8 w-full lg:w-1/2">
                        ...
                        <input id="nama_dosen" name="nama_dosen" class="form-input @error('nama_dosen') error @enderror"
                            type="text" value="{{ old('nama_dosen') }}" autocomplete="off"
                    ...
                    <div class="pr-6 pb-8 w-full lg:w-1/2">
                        ...
                        <input id="nidn" name="nidn" class="form-input @error('nidn') error @enderror" type="text"
                            value="{{ old('nidn') }}" autocomplete="off"
                            placeholder="Masukkan NIDN dari dosen pengampu" />
                        @error('nidn')
                            <div class="form-error">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="pr-6 pb-8 w-full lg:w-1/2">
                        ...
                        <input id="nama_matkul" name="nama_matkul" class="form-input @error('nama_matkul') error @enderror"
                            type="text" value="{{ old('nama_matkul') }}" autocomplete="off"
                            placeholder="Masukkan nama mata kuliah yang diampu" />
                        @error('nama_matkul')
                            <div class="form-error">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="pr-6 pb-8 w-full lg:w-1/2">
                        ...
                        <input id="kode_mk" name="kode_mk" class="form-input @error('kode_mk') error @enderror" type="text"
                            value="{{ old('kode_mk') }}" autocomplete="off"
                            placeholder="Masukkan kode mata kuliah yang diampu" />
                        @error('kode_mk')
                            <div class="form-error">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="pr-6 pb-8 w-full lg:w-1/2">
                        ...
                        <select id="id_lab" name="id_lab" class="form-select @error('id_lab') error @enderror">
                            <option></option>
                            @foreach ($Lab as $item)
                    ...
                    <div class="pr-6 pb-8 w-full lg:w-1/2">
                        ...
                        <select id="kategori" name="kategori" class="form-select @error('kategori') error @enderror">
                            <option value=""></option>
                    ...
                    <div class="pr-6 pb-8 w-full lg:w-1/3">
                        ...
                        <input id="tanggal" name="tanggal" class="form-input @error('tanggal') error @enderror" type="date"
                            value="{{ old('tanggal') }}" />
                        @error('tanggal')
                            <div class="form-error">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="pr-6 pb-8 w-full lg:w-1/3">
                        ...
                        <input id="jam_pinjam" name="jam_pinjam" class="form-input @error('jam_pinjam') error @enderror"
                            type="time" value="{{ old('jam_pinjam') }}" />
                        @error('jam_pinjam')
                            <div class="form-error">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="pr-6 pb-8 w-full lg:w-1/3">
                        ...
                        <input id="jam_kembali" name="jam_kembali" class="form-input @error('jam_kembali') error @enderror"
                            type="time" value="{{ old('jam_kembali') }}" />
                        @error('jam_kembali')
                            <div class="form-error">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="px-8 py-4 bg-gray-100 border-t border-gray-200 flex justify-end items-center">
                    ...
                    <button type="submit" id="user-pinjam-lab-create" class="btn-indigo" data-nim="{{}}">
                        Ajukan Permohonan
                    </button>
                </div>
            </form>
