                ...
                @foreach($JasaInstallasi as $elemen)
                    <tr>
                        ...
                        <td class="project-actions text-right">
                            <button class="btn btn-secondary btn-sm detail-jasainstallasi-button" type="button" data-toggle="modal" data-target="#peminjamanLabModal" data-showurl="{{ route('JasaInstallasi.show', $elemen->id) }}">
