...
<html>
<head>
    <title>Labkom FMIPA UNS | 500 Error</title>
    <meta charset="utf-8">
    ...
    <div class="w-9/12 m-auto py-16 min-h-screen flex flex-col items-center justify-center">
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-lg pb-8">
            <div class="border-t border-gray-200 text-center pt-8">
                <h1 class="text-9xl font-bold text-purple-600">500</h1>
                <h1 class="text-6xl font-bold py-2 text-purple-600">Server Error</h1>
                <p class="text-2xl pb-8 px-12 font-medium">Whoops, something went wrong on our servers.</p>
