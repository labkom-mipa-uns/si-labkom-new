...
@section('title', 'Labkom FMIPA UNS | Account | Edit Data')

@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0 text-dark">Edit Data Account</h1>
        </div>
        <!-- /.col -->
        <div class="col-sm-6">
    ...
    <form action="{{ route('Account.update', $User->id) }}" method="post">
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <label for="Account">{{ __('Name') }} :</label>
                            <input type="text" name="name" id="Account" class="form-control @error('name') is-invalid @enderror" placeholder="Masukkan Nama" value="{{ $User->name }}" autocomplete="off">
                            @error('name')
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card-body">
                    <div class="card-tools" >
                        <a href="{{ route('Account.index') }}" class="btn btn-secondary btn-lg">Cancel</a>
